...
const { data, datasub } = usePage().props;
const form = useForm({
    id: datasub.id,
    id_manajemen: data.id,
    nama_submanajemen: datasub.nama_submanajemen,
    ket_nilai_0: datasub.ket_nilai_0,
    ket_nilai_4: datasub.ket_nilai_4,
    ket_nilai_7: datasub.ket_nilai_7,
    ket_nilai_10: datasub.ket_nilai_10,
});

const submitCreate = () => {
    form.patch(route('submanajemen.update', { id: data.id, id_sub: datasub.id }), {
        onSuccess: () => {
            Swal.fire({
                title: 'Berhasil!',
                text: 'Telah Memperbaharui Data',
                icon: 'success',
            });
        },
    });
        ...
        <div class="py-4 font-sans">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <h2 class="font-semibold text-xl text-slate-500 leading-tight mb-4">
                    Edit {{ datasub.nama_submanajemen }}
                </h2>
