...
const confirmDeletion = (id, nama) => {
    const form = useForm({
        id: id,
    });
    Swal.fire({
        title: "Apakah kamu yakin?",
        text: `Kamu akan menghapus ${nama} ini!`,
        icon: "warning",
        ...
        if (result.isConfirmed) {
            form.delete(route('submanajemen.delete', { id: name.id }), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Dihapus!",
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-6 p-6 bg-white shadow-md rounded-sm">
                    <div class="flex justify-end mb-4">
                        <Link :href="route('submanajemen.create', { id: name.id })"
                            ...
                            <tr v-for="(data, index) in data" :key="index">
                                ...
                                <td class="flex justify-between">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <Link :href="route('submanajemen.edit', { id: name.id, id_sub: data.id })"
                                            class="text-polynesian-blue hover:text-carolina-blue">
                                        <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                        </Link>
                                        <button @click="() => confirmDeletion(data.id, data.nama_submanajemen)"
