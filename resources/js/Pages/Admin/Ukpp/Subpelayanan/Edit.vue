...
const datasub = usePage().props.datasub;
const form = useForm({
    id: datasub.id,
    id_ukpp: data.id,
    subpelayanan: datasub.subpelayanan,
    str_pembilang: datasub.str_pembilang,
    str_penyebut: datasub.str_penyebut,
    kali: datasub.kali,
    target: datasub.target,
    str_target: datasub.str_target,
    satuan: datasub.satuan,
    type: datasub.type,
});

const submitEdit = () => {
    form.patch(route('update.subpelayanan', { id: data.id, id_sub: datasub.id }), {
        onSuccess: () => {
            Swal.fire({
                title: 'Berhasil!',
        ...
        <div class="py-4 font-sans">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-6 p-6 bg-white shadow-md rounded-sm">
                    <form @submit.prevent="submitEdit" class="flex flex-wrap">
