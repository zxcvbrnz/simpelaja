            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-6 p-6 bg-white shadow-md rounded-sm">
                    <div class="flex justify-end mb-4">
                        <Link :href="route('add.subpelayanan', { id: name.id })"
                    ...
                    <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="2" class="text-start">Pelayanan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="(data, index) in data" :key="index">
                                ...
                                <td class="flex justify-between">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        <Link
                                            :href="route('pelayanan.detail.admin', { id_pelayanan: name.id, id_sub: data.id })"
                                            class="text-teal-600 hover:text-teal-500">
                                        <i class="fa-sharp fa-solid fa-eye"></i>
                                        </Link>
                                        <Link :href="route('edit.subpelayanan', { id: name.id, id_sub: data.id })"
                                            class="text-polynesian-blue hover:text-carolina-blue">
                                        <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                        </Link>
                                        <button @click="() => confirmDeletion(data.id, data.subpelayanan)"
