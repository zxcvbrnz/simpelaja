...
const confirmUkppDeletion = (id, name) => {
    const form = useForm({
        id: id,
    });
    Swal.fire({
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">
                                    Indikator Upaya Kesehatan Perseorangan dan Penunjang
                                </span>
                            </div>
                        </li>
                    </ol>
                            ...
                            <tr v-for="(data, index) in data" :key="index">
                                ...
                                <td class="flex justify-between items-center">
                                    ...
                                    <div class="flex justify-center space-x-4 items-center">
                                        ...
                                        <Link :href="route('edit.ukpp', { id: data.id })"
                                            class="text-polynesian-blue hover:text-carolina-blue">
                                        <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                        </Link>
                                        <button @click="() => confirmUkppDeletion(data.id, data.pelayanan)"
