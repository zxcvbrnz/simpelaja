...
const confirmDeletion = (id, name) => {
    ...
    Swal.fire({
        ...
        text: `Kamu akan menghapus SDM ${name} ini!`,
        icon: "warning",
        ...
        if (result.isConfirmed) {
            form.delete(route('sdm.delete'), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Dihapus!",
                        text: "SDM telah dihapus.",
                        icon: "success"
                    }).then((result) => {
                        location.reload();
                    });
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-6 p-6 bg-white shadow-md rounded-sm">
                    ...
                    <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                        <thead>
                            <tr>
                                <th data-priority="1" class="text-start">Nama SDM</th>
                                <th data-priority="2" class="text-start">Jumlah SDM</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td class="flex justify-between items-center">
                                    <span><span
                                            class="mr-5 font-bold overflow-hidden whitespace-nowrap text-ellipsis"></span>{{
                                                data.jumlah_sdm }}</span>
                                    <div class="flex justify-center space-x-4 items-center">
                                        <Link :href="route('sdm.edit', { id: data.id })"
                                            class="text-polynesian-blue hover:text-carolina-blue">
                                        <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                                        </Link>
                                        <button @click="() => confirmDeletion(data.id, data.nama_sdm)"
