                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link :href="route('program.detail', { id: $page.props.program.id })"
                                    class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">
                                {{ $page.props.program.program }}</Link>
                            </div>
                        </li>
                        <li v-if="$page.props.auth.user.role == 'admin'">
                            <div class="flex items-center">
                                ...
                                <Link
                                    :href="route('program.detail.admin', { id_program: $page.props.program.id, id_sub: sub.id })"
                                    class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">
                                {{ sub.nama }}</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">
                                    {{ $page.props.auth.user.role == 'puskesmas' ? sub.nama : $page.props.username }}
                                </span>
                            </div>
                        </li>
                    </ol>
