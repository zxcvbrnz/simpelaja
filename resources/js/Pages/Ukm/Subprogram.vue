...
const { data, name, capaian } = usePage().props;
    ...
    <AuthenticatedLayout>
        <div class="py-4 font-sans">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <h2
                    class="font-semibold text-xl text-slate-500 leading-tight mb-4"
                >
                    {{ name.program }}
                </h2>
                <nav
                    class="flex bg-white px-4 py-6 shadow-md"
                        ...
                        <tbody>
                            <tr v-for="(data, index) in data" :key="index">
                                ...
                                <td class="flex justify-between">
                                    <div class="flex items-center">
                                        <span
                                            class="ml-4 font-normal overflow-hidden whitespace-nowrap text-ellipsis"
                                        >
                                            {{ data.nama }}
                                        </span>
                                        <div
                        ...
                        :href="
                            route('ukm.export', {
                                start_time: form.start_time
                                    ? form.start_time
                                    : 0,
                                end_time: form.end_time ? form.end_time : 0,
                            })
                        "
                        >Export Excel</a
                    >
