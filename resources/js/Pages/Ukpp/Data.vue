...
const submitCreate = () => {
    form.post(route('pelayanan.data.add', { id_sub: sub.id }), {
        onSuccess: () => {
            Swal.fire({
                title: 'Berhasil!',
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li v-if="$page.props.auth.user.role == 'admin'">
                            <div class="flex items-center">
                                ...
                                <Link
                                    :href="route('pelayanan.detail.admin', { id_pelayanan: $page.props.pelayanan.id, id_sub: sub.id })"
                                    class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">
                                {{ sub.subpelayanan }}</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">
                                    {{ $page.props.auth.user.role == 'puskesmas' ? sub.subpelayanan : $page.props.username
                                    }}
                                </span>
                            </div>
                        </li>
